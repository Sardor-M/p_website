  ...
  return (
    <ProjectsContainer isDarkMode={isDarkMode}>
      <SectionWrapper>
        ...
        <PageTitle ref={pageTitleRef} isDarkMode={isDarkMode} style={{ transitionDelay: '200ms' }}>
          What I've Built
        </PageTitle>
                ...
                <ProjectInfo isDarkMode={isDarkMode}>
                  ...
                  >
                    <ProjectStat isDarkMode={isDarkMode}>
                      <StatLabel isDarkMode={isDarkMode}>audience reached</StatLabel>
                      <StatValue isDarkMode={isDarkMode}>{project.audience}</StatValue>
                    </ProjectStat>
                    <ProjectStat isDarkMode={isDarkMode}>
                      <StatLabel isDarkMode={isDarkMode}>
                        audience new people around the project
                      </StatLabel>
                      <StatValue isDarkMode={isDarkMode}>{project.audience}</StatValue>
                    </ProjectStat>
                  </ProjectStats>
