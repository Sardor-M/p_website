...
const CopyButton = styled(Button).attrs({
  ...
  &:hover {
    background: ${({ theme }) =>
      theme.mode === 'dark' ? themeColor.copyBtnBgHoverDark : themeColor.copyBtnBgHoverLight};
  }
`;
...
`;
// languageMap ni yaratamiz (highlight.js uchun)
...
export default function CodeBlock({
  ...
  // trailing commas, semicolonlarni olib tashlaydi
